...
export function Aim() {
  return (
    <div className="bg-gray-300 w-full h-screen relative">
      ...
      <div className="lg:absolute lg:left-1/4 lg:top-32 aim-background w-full lg:w-[65rem] h-[35rem] ">
        <div className="p-32 lg:p-10 bg-transparent lg:bg-white w-full lg:w-[20rem] h-60 lg:-mt-10 lg:float-right lg:-mx-10 m-auto">
          <h1 className="text-black text-xl font-extrabold uppercase text-center lg:text-left">
            Helping each child find and follow their best learning path.
          </h1>
        </div>

        <div className="grid grid-cols-4 lg:grid-cols-2 gap-2 lg:gap-10 absolute bottom-10 lg:-bottom-40 mx-5 lg:mx-0">
